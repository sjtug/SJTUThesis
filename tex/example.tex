...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=0.3\textwidth]{example/insertimage/sjtulogo.png}
  \hspace{1cm}
  \includegraphics[width=0.3\textwidth]{example/insertimage/sjtulogo.jpg}
...
%     \includegraphics[width=0.3\textwidth]{example/insertimage/sjtulogo.eps}}
%   \hspace{1in}
%   \subfigure[PDF Figure]{
%     \label{fig:epspdf:b} %% label for second subfigure
%     \includegraphics[width=0.3\textwidth]{example/insertimage/sjtulogo.pdf}}
...
\begin{figure}[!htp]
 \centering
 \includegraphics[width=4cm]{example/insertimage/sjtulogo.pdf}
