...
\begin{figure}[!htp]
  \centering
  \includegraphics[width=0.3\textwidth]{insertimage/sjtulogo.png}
  \hspace{1cm}
  \includegraphics[width=0.3\textwidth]{insertimage/sjtulogo.jpg}
...
%     \includegraphics[width=0.3\textwidth]{insertimage/sjtulogo.eps}}
%   \hspace{1in}
%   \subfigure[PDF Figure]{
%     \label{fig:epspdf:b} %% label for second subfigure
%     \includegraphics[width=0.3\textwidth]{insertimage/sjtulogo.pdf}}
...
\begin{figure}[!htp]
 \centering
 \includegraphics[width=4cm]{insertimage/sjtulogo.pdf}
...
\subsection{绘制流程图}
\label{sec:draw_picture}

图\ref{fig:flow_chart}是一张流程图示意。使用\verb+tikz+环境，搭配四种预定义节点（\verb+startstop+、\verb+process+、\verb+decision+和\verb+io+），可以容易地绘制出流程图。
\begin{figure}[!htp]
    \centering
    \resizebox{6cm}{!}{\input{figure/draw_picture/flow_chart.tex}}
    \bicaption[fig:flow_chart]{这里将出现在插图索引}{流程图}{Fig}{Flow chart}
\end{figure}
