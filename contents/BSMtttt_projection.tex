The Run~2 search for heavy resonances in $t\bar{t}t\bar{t}$ final states has established competitive constraints on a variety of top-philic new physics scenarios. 
...
The High-Luminosity LHC (HL-LHC) programme will substantially extend the kinematic reach and statistical precision available for searches for heavy resonances in $t\bar{t}t\bar{t}$ final states. 
