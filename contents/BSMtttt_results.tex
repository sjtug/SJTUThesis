...
\begin{table}[htbp!]
    ...
    uncertainty in the $\boldsymbol{t\bar{t}H/A \to t\bar{t}t\bar{t}}$ cross-section and the total uncertainty.}
    \end{center}
\end{table}
...
\caption{
Goodness-of-fit $\boldsymbol{p}$-values for the signal-plus-background hypothesis
...
\begin{figure}[htbp!]
  ...
  The fitted signal strength $\boldsymbol{\mu}$ is shown in the left panel, while the observed significances are shown in the right panel.}
\end{figure}
...
\begin{figure}[htbp!]
  ...
  $\boldsymbol{\sigma(pp \to t\bar{t}H/A)\times\mathcal{B}(H/A \to t\bar{t})}$, as a function of $\boldsymbol{m_{H/A}}$.
  The green (yellow) band represents the $\boldsymbol{\pm1\sigma}$ ($\boldsymbol{\pm2\sigma}$) interval around the expected limit.
  Theoretical predictions for two values of $\boldsymbol{\tan\beta}$ are shown for an $\boldsymbol{H}$ boson.
  The corresponding predictions for $\boldsymbol{A}$ differ by less than $\boldsymbol{3\,\text{\textperthousand}}$ for all mass points and $\boldsymbol{\tan\beta}$ values considered.}
...
\begin{figure}[htbp!]
  ...
  \caption{
  Observed (red solid) and expected (black dashed) 95\% CL lower limits on $\boldsymbol{\tan\beta}$
  as a function of $\boldsymbol{m_{H/A}}$ obtained from the 1L and 2LOS final states,
  assuming a Type-II 2HDM in the alignment limit.
  Values of $\boldsymbol{\tan\beta}$ below the observed limit are excluded.
  Panel (a) shows the scenario with $\boldsymbol{m_H=m_A}$, while panels (b) and (c)
  correspond to the $\boldsymbol{H}$-only and $\boldsymbol{A}$-only scenarios.
  The yellow band indicates the $\boldsymbol{\pm1\sigma}$ interval around the expected limit,
  and the red dashed lines show the effect of varying the theoretical cross-sections by $\boldsymbol{\pm1\sigma}$.
  Values of $\boldsymbol{\tan\beta<0.4}$ are not considered to maintain perturbativity of the top-quark Yukawa coupling~\cite{Branco:2012}.}
  \label{fig:2D_1LOS}
\end{figure}
...
\begin{figure}[htbp!]
  ...
  \caption{
  Observed (red solid) and expected (black dashed) 95\% CL lower limits on $\boldsymbol{\tan\beta}$
  as a function of $\boldsymbol{m_{H/A}}$ obtained from the 1L/2LOS and 2LSS/ML final states,
  assuming a Type-II 2HDM in the alignment limit.
  Values of $\boldsymbol{\tan\beta}$ below the observed limit are excluded.
  Panel (a) shows the scenario with $\boldsymbol{m_H=m_A}$, while panels (b) and (c)
  correspond to the $\boldsymbol{H}$-only and $\boldsymbol{A}$-only scenarios.
...
\subsection{Interpretation in the $S_{8}$ model}
...
In this scenario, $S_{8}$s are pair-produced via the strong interaction and subsequently decay into top-quark pairs, leading to a $t\bar{t}t\bar{t}$ final state.
