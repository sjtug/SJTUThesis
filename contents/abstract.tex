...
\begin{abstract}[en]
  ...
  This thesis presents a search for heavy resonance in four-top-quark final states using events with one lepton or two opposite-sign leptons and high jet multiplicities. 
  ...
  Projections to the High-Luminosity LHC (HL-LHC) indicate that, with $3~\mathrm{ab}^{-1}$ of data at $\sqrt{s}=14~\mathrm{TeV}$, cross-section sensitivities below 1~fb can be achieved for masses above 1~TeV.

  To further exploit the physics potential of four-tops production, a reconstruction and unfolding framework is developed for differential measurements in Run~3 data. 
  ...
  The neutrino kinematics are inferred using both analytic techniques and machine-learning-based approaches, enabling the reconstruction of parton-level observables such as the four-tops invariant mass $m_{4t}$. 
  ...
  % Overall, this thesis demonstrates the strong potential of the four-top topology as a probe of both the Standard Model and new physics. 
