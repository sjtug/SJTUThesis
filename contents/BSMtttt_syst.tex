...
An additional modelling uncertainty is derived from the comparison between the nominal five-flavour-scheme \textsc{Powheg}+\textsc{Pythia8} prediction and an alternative four-flavour-scheme NLO prediction obtained with \textsc{Powheg-Box}\allowbreak-\textsc{Res}.
