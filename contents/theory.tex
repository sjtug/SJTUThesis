...
As the SM is a completely QFT under the framework of local gauge invariance, while gravity is best described by general relativity~\cite{Einstein1916GR}, a classical theory of curved spacetime.
Any attempt to quantise gravity in a straightforward manner leads to a non-renormalisable theory, indicating that a more profound framework is needed to unify gravity with the other forces.
Another missing piece is dark matter and dark energy, which together constitute about 95\% of the total energy density of the universe and have been firmly established through astrophysical and cosmological observations~\cite{Begeman1991RotationCurves,PlanckXVI2014CosmologicalParameters}.
...
For instance, the neutrino oscillation experiments have demonstrated that neutrinos have small but non-zero masses~\cite{Fukuda1998NeutrinoOscillation}, which cannot be accommodated within the minimal SM framework.
...
Explaining this asymmetry requires satisfying the Sakharov conditions~\cite{Sakharov:1967dj}: baryon number violation, C and CP violation, and departure from thermal equilibrium.
...
The SM also remains puzzling in several theoretical aspects, one of which is the hierarchy problem.
...
The interactions between the Higgs doublets and fermions are described by the Yukawa sector. In the most general renormalisable form, both Higgs doublets can couple to a given fermion species, leading to
\[
\begin{aligned}
...
Imposing such a symmetry leads to several phenomenologically distinct realisations of the 2HDM, classified according to the Higgs doublet responsible for generating the masses of different fermion species. 
...
Models containing a colour-octet scalar \(S_8\), commonly referred to as a
\textit{sgluon}, predict a particle transforming in the adjoint representation
of \(\mathrm{SU}(3)_\mathrm{c}\) and therefore interacting strongly with gluons.

As illustrated in Fig.~\ref{fig:sgluontotttt}, pairs of sgluons can be produced efficiently at the LHC through
...
In simplified models, the coupling of the sgluon to top quarks is
parameterised by a Yukawa-like coupling \(y_{S_8}\).
For moderate values of this coupling, the dominant contribution to the
four-top final state arises from sgluon pair production followed by the
...
decay of a single heavy resonance, the sgluon scenario involves the
