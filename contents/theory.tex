...
The SM also remains puzzeling in several theoretical aspects, one of which is the hierarchy problem.
...
\section{Top Quarks and Four-Top Production}
\label{sec:four-top}
...
Before discussing the mechanisms contributing to four-top production,
the key properties of the top quark are briefly summarised.

\subsection{Top-quark properties}
\label{subsec:top_properties}

The top quark was discovered in 1995 by the CDF and D0 collaborations at the Fermilab Tevatron,
