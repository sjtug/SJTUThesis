...
followed by a discussion of the top quark and four-tops production in Section~\ref{sec:four-tops}.
...
scaling approximately as $1/\tan\beta$ in the Type-II scenario\cite{Hajer:2015gka}. As a result, processes involving top quarks provide a particularly sensitive probe of the extended Higgs sector, motivating searches in multi-top final states.

\subsection{Top-Philic Simplified Models}\label{subsec:S1/S8}

The top quark occupies a unique position within the Standard Model (SM) which will be detailed discussed in Section~\ref{sec:four-tops}.
...
\paragraph{Four-Tops production via sgluons.}
...
mechanism for enhancing four-tops production.
...
\(S_8 \to t\bar{t}\), resulting in a four-tops final state from sgluon pair production.
...
\caption{BSM contributions to four-tops production: (left) 2HDM heavy scalar \(H/A\); (right) sgluon pair decay.}
