...
%=========================================================
\section{Event Selection and Region Definition}
...
multiplicity characteristic of four-top final states
...
\begin{itemize}
  ...
  targeting semileptonic decays of the top quarks.

  \item \textbf{2LOS channel:} events containing exactly two
  isolated leptons with opposite electric charge,
  targeting dileptonic top-quark decays.
\end{itemize}

The two channels are analysed separately due to their
different background compositions and kinematic properties.

%---------------------------------------------------------
\subsection{Baseline jet and $b$-jet requirements}
%---------------------------------------------------------
...
%---------------------------------------------------------
\subsection{Region categorisation}
%---------------------------------------------------------
...
The complete set of $b$-tag multiplicity definitions used
...
\begin{table}[htbp]
  \centering
  \caption{
    Definition of the $b$-jet multiplicity requirements
