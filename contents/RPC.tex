...
To address these limitations, an upgrade of the RPC system is foreseen. 
In the barrel inner (BI) region, a new detector layout is introduced,
featuring three RPC triplets corresponding to a total of nine gas
...
high-rate conditions expected at the HL-LHC. The conditioning
procedure involves gradually increasing the applied high voltage
