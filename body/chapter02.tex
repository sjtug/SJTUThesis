...
这是全文唯一的一个四级标题。在这部分中将演示可伸长符号（箭头、等号的例子）的例子，以及如何在可伸长的符号上标注。在《CTeX常见问题集》中也由类似的介绍。
...
\begin{figure}[!htp]
  \centering
  \includegraphics[scale=0.4]{chap2/fig1.jpg}
  \includegraphics[scale=0.4]{chap2/fig2.jpg}
