...
% 单面打印（注意字号设置）
\documentclass[c5size, a4paer, oneside, openany]{sjtuthesis}
 
\usepackage{geometry}
\geometry{paperwidth=21cm,paperheight=29.7cm}
\geometry{left=3.18cm,right=3.18cm, top=33.5mm,bottom=2.54cm}
\geometry{headheight=1.9cm,headsep=5pt,footskip=12.5mm}
